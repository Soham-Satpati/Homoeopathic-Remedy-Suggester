...
with tab1:
    ...
    if st.button("Analyze Case → Proceed to Refinement", type="primary", use_container_width=True):
    ...
    # =============================================
    st.divider()
    st.subheader("Optional Step 3: Discover Hidden Clinical Patterns")

    with st.expander("Find associated symptoms from real case clusters", expanded=False):
        ...
        if st.button("Update Report with Hidden Patterns", type="primary"):
